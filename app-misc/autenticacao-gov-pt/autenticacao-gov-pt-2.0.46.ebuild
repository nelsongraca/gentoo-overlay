...
DESCRIPTION="Software para autenticar com o cartão de cidadão"
...
DEPEND="sys-apps/pcsc-lite
	sys-apps/pcsc-tools
	app-crypt/ccid
	( >=virtual/jdk-1.8:1.8 || ( >=dev-java/oracle-jdk-bin-1.8:1.8 dev-java/icedtea dev-java/icedtea-bin dev-java/openjdk dev-java/openjdk-bin ) )"
RDEPEND="${DEPEND}
